...
public partial class SzemelyiEdzokEdzok
{
    ...
    public virtual ICollection<SzemelyiEdzokFoglalasok> SzemelyiEdzokFoglalasok { get; } = new List<SzemelyiEdzokFoglalasok>();
}
